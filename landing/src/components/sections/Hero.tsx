...
export const Hero = () => {
  return (
    <section className="relative min-h-[100dvh] w-full flex items-center justify-center overflow-hidden bg-zinc-950 text-zinc-50 font-sans selection:bg-emerald-500/30">
